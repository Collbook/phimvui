...
function set_value_slide($noidung){
	
	$doc = new DOMDocument();
	$doc->formatOutput = true;   
	$rootNode = $doc->createElement('slide');
	$doc->appendChild($rootNode);
	$amount = $doc->createElement('amount');
	$amount->appendChild($doc->createTextNode($noidung)); 
	$rootNode->appendChild($amount); 
