                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            @if(!empty($film->img_thumbnail) && file_exists(public_path(get_thumbnail("assets/frontend/images/".$film->img_thumbnail))))
                                                                <img src="{{ asset("assets/frontend/images/".get_thumbnail($film->img_thumbnail)) }}"
...
@section('body.css')
    ...
    <link rel="stylesheet" href="{{asset('css/phim/modal.css')}}">
@endsection

@section('body.script')
    <script src="assets/backend/dist/js/data_table_paginate.js"></script>
    <script src="{{ asset('js/active-slide.js') }}"></script>
