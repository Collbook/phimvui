...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Thêm đạo diễn</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <form role="form" action="{{ route('admin.director.create') }}" method="POST" enctype='multipart/form-data'>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="director">Họ tên : </label>
                <input type="text" name="fullname" class="form-control" id="director" placeholder="Mời bạn nhập họ tên...">
              </div>
              <div class="form-group">
                <label>Mô tả : </label>
