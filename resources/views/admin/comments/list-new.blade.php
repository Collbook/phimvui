...
@section('body.content')
    ...
    <div id="ajax-table-admin-user">
        <div class="content-wrapper" ng-app="myApp" ng-controller="namesCtrl">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                @if(!empty($comment->films->img_thumbnail) && file_exists(public_path(get_thumbnail("assets/frontend/images/".$comment->films->img_thumbnail))))
                                    <img src="{{ asset("assets/frontend/images/".get_thumbnail($comment->films->img_thumbnail)) }}" alt="Image" width="60px" class="center-block">
                                @else
